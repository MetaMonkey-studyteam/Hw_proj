...
<form action="store" method="post">
    ...
    <box>
        ...
        <br>
        <input type="checkbox" id="strawberry" value="strawberry-5000" name="item"><label for="strawberry">딸기크로플 :
        5000원</label>
    </box>
    <br>
    <box>
        ...
        <br>
        <input type="checkbox" id="choco" value="choco-4000" name="item"><label for="choco">초코크로플 : 4000원</label>
    </box>
    <br>
    <box>
        <img src="./image/cheese.png" style="width: 200px; height: 200px;">
        <br>
        <input type="checkbox" id="cheese" value="cheese-4500" name="item"><label for="cheese">치즈크로플 : 4500원</label>
    </box>
    <br>
    <box>
    ...
    <box>
        ...
        <br>
        <input type="checkbox" id="plain" value="plain-3500" name="item"><label for="plain">플레인크로플 : 3500원</label>
    </box>
    <br>
